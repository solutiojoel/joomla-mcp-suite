...
- [Joomla host throttling](joomla-host-throttling.md) — host 429s cloud IPs after ~2 rapid requests; all client-side pacing/backoff REMOVED 2026-07-30, we fail fast on 429 and fix it by allowlisting the egress IP.
