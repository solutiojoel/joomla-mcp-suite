...
- [rtk Hook Windows Gotcha](rtk-hook-windows-gotcha.md) — "No hook installed" is a false positive from PS wrapper; fix is bare `rtk hook claude`; rg needs winget install
