# Particle Inventory -- Assumption-Center

**URL:** https://assumption-center.backup.solutiosoftware.com  
...
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _Recent Parish News_  
...
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _20 Chestnut Street Centereach, NY 11720 Phone: 631-585-8760 rectory@abvmcentereach.com_  
...
### `contentarray` -- `.boxes-container`

**Particle ID:** `contentarray-3536-particle`  
**Block classes:** `size-100 boxes-container`  
**Selectors:** `.boxes-container`, `#contentarray-3536-particle`  
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _Our Mission Love God. Serve Others. Grow Disciples You Matter + You Belong Who We Are Mass Schedule Saturday Vigil: 5..._  
...
### `contentarray` -- `.ph-rounded-square` `.ph-rounded-square-mobile` `.ph-wide`

**Particle ID:** `contentarray-6756-particle`  
**Block classes:** `size-100 ph-rounded-square ph-rounded-square-mobile ph-wide`  
**Selectors:** `.ph-rounded-square`, `.ph-rounded-square-mobile`, `.ph-wide`, `#contentarray-6756-particle`  
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _Men’s Ministry BBQ Read More... Virtus Training Read More... Vacation Bible School Read More..._  
...
### `contentarray` -- `.nav-main-menu`

**Particle ID:** `contentarray-9533-particle`  
**Block classes:** `size-100 nav-main-menu`  
**Selectors:** `.nav-main-menu`, `#contentarray-9533-particle`  
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _I'm New I'm New Calendar Calendar Faith Formation Faith Formation Give Give_  

**CSS rules matched:** 98  
...
**Block classes:** `size-100 ql-sbound`  
**Selectors:** `.ql-sbound`, `#blockcontent-9668-particle`  
**Pages:** https://assumption-center.backup.solutiosoftware.com/  
**Content hint:** _Next Steps Next Steps Funerals Funerals Small Groups Small Groups Prayer Wall Prayer Wall Bulletin Bulletin_  
