# Particle Inventory -- Olg-Green

**URL:** https://olg-green.backup.solutiosoftware.com  
...
**Particle ID:** `custom-9537-particle`  
**Block classes:** `size-79`  
**Selectors:** `#custom-9537-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Latest News_  
...
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Our Lady of the Greenwood Catholic School 399 South Meridian Street Greenwood, IN 46143 Office: 317-881-1300 Fax: 317..._  

**CSS rules matched:** 50  
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-15 { flex-grow: 0; flex-shrink: 1; flex-basis: 15%; width: 15% }
...
.g-content { margin-top: 0.625rem; margin-right: 0.625rem; margin-bottom: 0.625rem; margin-left: 0.625rem; padding-top: 1.5rem; padding-right: 1.5rem; padding-bottom: 1.5rem; padding-left: 1.5rem }
.g-flushed .g-content { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
html body #g-navigation { --main-menu-text-color: var(--default-white); --main-menu-text-color-hover: var(--default-white); --main-menu-bg: transparent; --main-menu-bg-color: transparent; --navigation-floating-social-padding: min(1vw, 1rem); --section-navigation-bg: transparent }
```
</details>
...
### `contentarray` -- `.size-33-3` `.facebook-widget-container` `.widget-container`

**Particle ID:** `contentarray-6583-particle`  
**Block classes:** `size-33-3 facebook-widget-container widget-container`  
**Selectors:** `.size-33-3`, `.facebook-widget-container`, `.widget-container`, `#contentarray-6583-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Facebook Follow Us_  
...
### `contentarray` -- `.size-33-3` `.calendar-widget-container` `.widget-container`

**Particle ID:** `contentarray-3150-particle`  
**Block classes:** `size-33-3 calendar-widget-container widget-container`  
**Selectors:** `.size-33-3`, `.calendar-widget-container`, `.widget-container`, `#contentarray-3150-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
...
### `contentarray` -- `.size-33-3` `.helplinks-widget-container` `.widget-container`

**Particle ID:** `contentarray-7651-particle`  
**Block classes:** `size-33-3 helplinks-widget-container widget-container`  
**Selectors:** `.size-33-3`, `.helplinks-widget-container`, `.widget-container`, `#contentarray-7651-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Helpful Links Indiana Graduates Donate Now_  

**CSS rules matched:** 41  
...
### `contentarray` -- `.safe-container`

**Particle ID:** `contentarray-2997-particle`  
**Block classes:** `size-100 safe-container`  
**Selectors:** `.safe-container`, `#contentarray-2997-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Child Safety and Misconduct Reporting Resources All Schools operated by schools and parishes under the guidance of th..._  
...
### `contentarray` -- `.ph-title-text`

**Particle ID:** `contentarray-3524-particle`  
**Block classes:** `size-100 ph-title-text`  
**Selectors:** `.ph-title-text`, `#contentarray-3524-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Summer Office Hours (subject to change) June 1 - June 30 : School office is open weekday mornings from 9:00 - 12:00 n..._  
...
**Particle ID:** `custom-9537-particle`  
**Block classes:** `size-100 news-title`  
**Selectors:** `.news-title`, `#custom-9537-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Latest News_  
...
**Particle ID:** `custom-1431-particle`  
**Block classes:** `size-100 news-button`  
**Selectors:** `.news-button`, `#custom-1431-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _View All Headlines_  
...
### `logo` -- `.hidden-phone` `.sh-circle-icon`

**Particle ID:** `logo-2020-particle`  
**Block classes:** `size-15 hidden-phone sh-circle-icon`  
**Selectors:** `.hidden-phone`, `.sh-circle-icon`, `#logo-2020-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
...
**Particle ID:** `logo-6507-particle`  
**Block classes:** `size-55 hidden-phone`  
**Selectors:** `.hidden-phone`, `#logo-6507-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
...
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Home About Academics Admissions Parents News Sponsors_  

**CSS rules matched:** 65  
...
**Particle ID:** `custom-3488-particle`  
**Block classes:** `size-100`  
**Selectors:** `#custom-3488-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
...
**Particle ID:** `mobile-menu-3809-particle`  
**Block classes:** `hidden size-100`  
**Selectors:** `.hidden`, `#mobile-menu-3809-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
...
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Parish Parish Eagle Flyer Eagle Flyer Schedule a Tour Schedule a Tour Apply Apply Support Our School Support Our School_  
...
### `contentarray` -- `.mission-container`

**Particle ID:** `contentarray-9664-particle`  
**Block classes:** `size-100 mission-container`  
**Selectors:** `.mission-container`, `#contentarray-9664-particle`  
**Pages:** https://olg-green.backup.solutiosoftware.com/school  
**Content hint:** _Mission Statement The Our Lady of the Greenwood Catholic School community is devoted to serving the diverse body of C..._  
