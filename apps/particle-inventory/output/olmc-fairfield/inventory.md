# Particle Inventory -- OLMC-Fairfield

**URL:** https://olmc-fairfield.backup.solutiosoftware.com  
...
### `blockcontent` -- `.ql-circle-row`

**Particle ID:** `blockcontent-9668-particle`  
**Block classes:** `size-100 ql-circle-row`  
**Selectors:** `.ql-circle-row`, `#blockcontent-9668-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _I'm New I'm New Update My Household Information Update My Household Information Become Catholic Become Catholic Relig..._  
...
**Particle ID:** `contentarray-6123-particle`  
**Block classes:** `size-30`  
**Selectors:** `#contentarray-6123-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Upcoming Events View Full Calendar_  
...
**Block classes:** `size-55`  
**Selectors:** `#contentarray-6756-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Recent News SIGN UP FOR ONLINE GIVING Please, prayerfully consider making your offering online to our parish. Your co..._  

**CSS rules matched:** 40  
...
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Mass Schedule WEEKEND Saturday: 5:00 PM (Vigil) Sunday: 8:00 AM, 10:00 AM, 12:00 PM, 2:00PM (Spanish), 6:00 PM DAILY ..._  

**CSS rules matched:** 78  
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-19 { flex-grow: 0; flex-shrink: 1; flex-basis: 19%; width: 19% }
...
.g-flushed .g-content { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
h4 { font-size: 1.25rem }
html body #g-navigation { --section-navigation-bg: var(--background-color); --main-menu-text-color: var(--default-white); --main-menu-text-color-hover: var(--default-white); --main-menu-bg: var(--secondary-color); --navigation-floating-social-padding: min(1vw, 1rem); --navigation-floating-social-bg: transparent; --navigation-floating-social-items-color: var(--primary-color) }
a { color: rgb(205, 150, 97) }
```
</details>
...
### `contentarray` -- `.instagram-widget-container` `.widget-container`

**Particle ID:** `contentarray-6583-particle`  
**Block classes:** `size-100 instagram-widget-container widget-container`  
**Selectors:** `.instagram-widget-container`, `.widget-container`, `#contentarray-6583-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _OLMC Fairfield_  
...
**Particle ID:** `contentarray-3303-particle`  
**Block classes:** `size-100 welcome-container`  
**Selectors:** `.welcome-container`, `#contentarray-3303-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Welcome Welcome to Our Lady of Mount Carmel Church. As a Carmelite parish, we are blessed to be a faith community cen..._  
...
### `contentarray` -- `.ph-sidenews`

**Particle ID:** `contentarray-6756-particle`  
**Block classes:** `size-100 ph-sidenews`  
**Selectors:** `.ph-sidenews`, `#contentarray-6756-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Recent News SIGN UP FOR ONLINE GIVING Please, prayerfully consider making your offering online to our parish. Your co..._  
...
### `blockcontent` -- `.align-right` `.ql-toplinks-studius`

**Particle ID:** `blockcontent-6888-particle`  
**Block classes:** `size-36 align-right ql-toplinks-studius`  
**Selectors:** `.align-right`, `.ql-toplinks-studius`, `#blockcontent-6888-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Bulletin Bulletin Contact Us Contact Us Online Giving Online Giving_  
...
**Particle ID:** `logo-8965-particle`  
**Block classes:** `size-50 show-mobile`  
...
**Particle ID:** `logo-2256-particle`  
**Block classes:** `size-45 hidden-phone`  
**Selectors:** `.hidden-phone`, `#logo-2256-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
...
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _About Our Lady Nuestra Señora News & Events Noticias y Eventos Get Involved Involúcrate Sacraments & Liturgy Sacramen..._  

**CSS rules matched:** 73  
...
### `social` -- `.align-right` `.nav-social-icons`

**Particle ID:** `social-5272-particle`  
**Block classes:** `size-50 align-right nav-social-icons`  
**Selectors:** `.align-right`, `.nav-social-icons`, `#social-5272-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
...
**Particle ID:** `custom-8572-particle`  
**Block classes:** `size-100`  
**Selectors:** `#custom-8572-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
...
**Particle ID:** `mobile-menu-7871-particle`  
**Block classes:** `hidden size-100`  
**Selectors:** `.hidden`, `#mobile-menu-7871-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
...
**Particle ID:** `contentarray-6123-particle`  
**Block classes:** `size-100 calendar-widget-container widget-container`  
**Selectors:** `.calendar-widget-container`, `.widget-container`, `#contentarray-6123-particle`  
**Pages:** https://olmc-fairfield.backup.solutiosoftware.com/  
**Content hint:** _Upcoming Events View Full Calendar_  
