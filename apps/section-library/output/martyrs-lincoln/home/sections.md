# Section Layout Inventory — Martyrs-Lincoln

**URL:** https://martyrs-lincoln.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:38 UTC  
**Sections:** 9
...
**Section styles:** background: rgb(143, 0, 41)
...
.fas { font-weight: 900 }
html body #g-navigation { --main-menu-text-color: var(--default-white); --main-menu-text-color-hover: var(--default-white); --main-menu-bg: var(--primary-color); --main-menu-bg-color: var(--primary-color); --navigation-floating-social-padding: min(1vw, 1rem); --section-navigation-bg: var(--default-white); --navigation-social-item-color: var(--default-white); --navigation-social-item-color-hover: var(--default-white) }
...
## Layout: `100/15|35|50/100`

### `g-navigation`

**Fingerprint:** `100/15|35|50/100`  
...
**Grid 2** `15|35|50`
  ...
  - size-35  → _(empty)_
  - size-50 `.ql-toplinks-studius` → `blockcontent`
**Grid 3** `100`
  - size-100  → `menu`
...
**Grid 1** `34|66`
  - size-34 `.facebook-widget-container` `.widget-container` → `contentarray`
  - size-66 `.mission-container` → `contentarray`
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-34 { flex-grow: 0; flex-shrink: 1; flex-basis: 34%; width: 34% }
.size-66 { flex-grow: 0; flex-shrink: 1; flex-basis: 66%; width: 66% }
...
**Fingerprint:** `70|30`  
**Section classes:** `.pushing-your-buttons` `.slideshow-spacing`  
**Pages:**   
![section screenshot](screenshots/g-slideshow.png)

**Grid 1** `70|30`
  - size-70 `.fullwidth-swiper` `.rotate-standard` → `swiper`
  - size-30 `.ql-swiper-sidelinks` → `blockcontent`
