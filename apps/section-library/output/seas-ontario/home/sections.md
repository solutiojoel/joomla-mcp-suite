# Section Layout Inventory — Seas-Ontario

**URL:** https://seas-ontario.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:35 UTC  
**Sections:** 10
...
**Grid 1** `100`
  - size-100 `.ql-circle-row` → `blockcontent`
...
**Grid 1** `100`
  - size-100 `.welcome-box` → `contentarray`
...
**Section styles:** background: rgb(20, 53, 112)
...
**Grid 2** `100`
  - size-100 `.mt-overlay-schedule` → `contentarray`
...
## Layout: `100/100/15|10|50|10|15/100`

### `g-navigation`

**Fingerprint:** `100/100/15|10|50|10|15/100`  
...
**Grid 2** `100`
  - size-100 `.header-contact-container` → `contentarray`
**Grid 3** `15|10|50|10|15`
  - size-15 `.hidden-phone` → `logo`
  - size-10  → _(empty)_
  - size-50 `.hiddenphone` → `logo`
  - size-10  → _(empty)_
  - size-15 `.align-right` `.nav-social-icons` → `social`
**Grid 4** `100`
  - size-100  → `menu`
