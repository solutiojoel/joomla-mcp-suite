...
**Section styles:** background: rgba(11, 60, 112, 0.9)
...
## Layout: `100/20|5|50|5|20/100`

### `g-navigation`

**Fingerprint:** `100/20|5|50|5|20/100`  
...
**Grid 2** `20|5|50|5|20`
  - size-20  → `custom`
  - size-5  → _(empty)_
  - size-50 `.hidden-phone` → `logo`
  - size-5  → _(empty)_
  - size-20 `.ql-toplinks-studius` → `blockcontent`
**Grid 3** `100`
  - size-100  → `menu`
...
## Layout: `6|44|44|6/100`

### `g-expanded`

**Fingerprint:** `6|44|44|6/100`  
**Section classes:** `.widget-parthenon-alt` `.beads-bottom`  
**Pages:**   
![section screenshot](screenshots/g-expanded.png)

**Grid 1** `6|44|44|6`
  - size-6  → _(empty)_
  - size-44 `.calendar-widget-container` `.widget-container` → `contentarray`
  - size-44 `.formed-widget-container` `.widget-container` → `contentarray`
  - size-6  → _(empty)_
**Grid 2** `100`
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-6 { flex-grow: 0; flex-shrink: 1; flex-basis: 6%; width: 6% }
...
**Fingerprint:** `70|30`  
**Section classes:** `.floatator` `.slideshow-spacing` `.beads-bottom`  
**Pages:**   
