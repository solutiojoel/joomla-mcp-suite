# Section Layout Inventory — Shelbyville

**URL:** https://shelbyville.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:23 UTC  
**Sections:** 9
...
**Fingerprint:** `100`  
**Section classes:** `.s-vertical-padding-2` `.beads-bottom`  
**Pages:**   
...
**Section styles:** background: rgb(240, 240, 240)
...
**Section styles:** background: rgb(11, 60, 112)
...
**Grid 1** `100`
  - size-100 `.enroll-container` `.widget-container` → `contentarray`
**Grid 2** `100`
...
## Layout: `100/45|26|29/100`

### `g-navigation`

**Fingerprint:** `100/45|26|29/100`  
**Section classes:** `.center-of-attention` `.stock`  
**Pages:**   
...
**Grid 2** `45|26|29`
  - size-45 `.hidden-phone` → `logo`
  - size-26  → _(empty)_
  - size-29 `.ql-toplinks-studius` → `blockcontent`
**Grid 3** `100`
  - size-100  → `menu`
...
.g-container.g-flushed { width: 100% }
#g-mainbar .moduletable { margin-top: -0.625rem; margin-right: -0.625rem; margin-bottom: -0.625rem; margin-left: -0.625rem }
```
</details>
