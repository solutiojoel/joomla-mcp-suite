# Section Layout Inventory — StAgnes-Concord

**URL:** https://stagnes-concord.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:29 UTC  
**Sections:** 11
...
**Grid 1** `100`
  - size-100 `.ql-blocktitle` → `blockcontent`

**Section styles:** background: rgb(9, 53, 28)
...
**Grid 1** `100`
  - size-100 `.calendar-container` → `contentarray`

**Section styles:** background: rgb(9, 75, 41)
...
**Section styles:** background: rgb(0, 38, 17)
...
**Grid 1** `100`
  - size-100 `.ql-ilinks` → `blockcontent`
**Grid 2** `100`
  - size-100 `.ilinks-button` → `custom`
...
## Layout: `100/100/40|35|25/100`

### `g-navigation`

**Fingerprint:** `100/100/40|35|25/100`  
...
**Fingerprint:** `50|35|15`  
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-container-main.png)

**Grid 1** `50|35|15`
  - size-50  → `contentarray`
  - size-35  → `contentarray`
  - size-15  → _(empty)_
...
**Section styles:** background: rgb(238, 238, 238)
