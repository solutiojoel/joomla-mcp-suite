# Section Layout Inventory — StAgnes-Greenport

**URL:** https://stagnes-greenport.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:39 UTC  
**Sections:** 9
...
**Section styles:** background: rgb(241, 241, 241)
...
**Section styles:** background: rgb(103, 0, 0)
...
## Layout: `100/15|55|5|25/100`

### `g-navigation`

**Fingerprint:** `100/15|55|5|25/100`  
...
**Grid 2** `15|55|5|25`
  - size-15 `.hidden-phone` `.logo-icon` → `logo`
  - size-55 `.hidden-phone` `.logo-text` → `logo`
  - size-5  → _(empty)_
