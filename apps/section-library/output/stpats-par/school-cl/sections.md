...
**Grid 1** `100`
  - size-100 `.ue-title` → `custom`
**Grid 2** `100`
  - size-100 `.ue-sideitems` → `timeline`
**Grid 3** `100`
  - size-100 `.ue-button` → `custom`
...
**Section styles:** background: rgb(0, 138, 68) | background-image: (set)
