# Particle Inventory -- SD-Cemetery

**URL:** https://sd-cemetery.backup.solutiosoftware.com  
...
### `contentarray` -- `.choose-container`

**Particle ID:** `contentarray-2729-particle`  
**Block classes:** `size-100 choose-container`  
**Selectors:** `.choose-container`, `#contentarray-2729-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/  
**Content hint:** _Why Choose Us? Holy Cross offers sacred Catholic burial in consecrated ground, rooted in Church tradition and the hop..._  

**CSS rules matched:** 37  
...
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _Holy Cross 4470 Hilltop Drive, San Diego, CA 92102 (619) 264-3127 Good Shepherd 1505 Buena Vista Drive Vista, CA 9208..._  

**CSS rules matched:** 45  
...
.g-content { margin-top: 0.625rem; margin-right: 0.625rem; margin-bottom: 0.625rem; margin-left: 0.625rem; padding-top: 1.5rem; padding-right: 1.5rem; padding-bottom: 1.5rem; padding-left: 1.5rem }
.g-flushed .g-content { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
html body #g-navigation { --section-navigation-bg: var(--default-white); --main-menu-text-color: var(--primary-color); --main-menu-text-color-hover: var(--primary-color); --main-menu-bg: var(--tertiary-color); --main-menu-bg-color: var(--tertiary-color); --navigation-floating-social-padding: min(1vw, 1rem) }
.g-array-item-text { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
...
### `blockcontent` -- `.linksources`

**Particle ID:** `blockcontent-2786-particle`  
**Block classes:** `size-100 linksources`  
**Selectors:** `.linksources`, `#blockcontent-2786-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/  
**Content hint:** _Local Resources Local Resources Visitors Guide Visitors Guide Find a Grave Find a Grave_  
...
### `contentarray` -- `.association-container`

**Particle ID:** `contentarray-8435-particle`  
**Block classes:** `size-100 association-container`  
**Selectors:** `.association-container`, `#contentarray-8435-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
...
**Particle ID:** `contentarray-1119-particle`  
**Block classes:** `size-100 welcome-container`  
**Selectors:** `.welcome-container`, `#contentarray-1119-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _Welcome to the Catholic Cemeteries of the Diocese of San Diego Holy Cross is sacred ground where we honor the dignity..._  
...
### `contentarray` -- `.info-container`

**Particle ID:** `contentarray-7725-particle`  
**Block classes:** `size-100 info-container`  
**Selectors:** `.info-container`, `#contentarray-7725-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/  
**Content hint:** _Holy Cross 4470 Hilltop Drive, San Diego, CA 92102 (619) 264-3127 Visit Holy Cross Good Shepherd 8301 Talbert Ave, Hu..._  
...
### `contentarray` -- `.translate-container`

**Particle ID:** `contentarray-9639-particle`  
**Block classes:** `size-100 translate-container`  
**Selectors:** `.translate-container`, `#contentarray-9639-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _San Diego Catholic Cemeteries Translate_  
...
**Particle ID:** `logo-7813-particle`  
**Block classes:** `size-60 hidden-phone`  
**Selectors:** `.hidden-phone`, `#logo-7813-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
...
**Particle ID:** `logo-7200-particle`  
**Block classes:** `size-40 hidden-phone`  
**Selectors:** `.hidden-phone`, `#logo-7200-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/holy-cross  
...
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _Home About Us Services Offered & Policies Resources Payment_  

**CSS rules matched:** 70  
...
**Particle ID:** `mobile-menu-9295-particle`  
**Block classes:** `hidden size-100`  
**Selectors:** `.hidden`, `#mobile-menu-9295-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
...
### `blockcontent` -- `.swiper-ql-overlay`

**Particle ID:** `blockcontent-8520-particle`  
**Block classes:** `size-100 swiper-ql-overlay`  
**Selectors:** `.swiper-ql-overlay`, `#blockcontent-8520-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _Search Burial Records Search Burial Records Sign up for E-News Sign up for E-News Photo Gallery Photo Gallery Holy Cr..._  

**CSS rules matched:** 25  
...
**Particle ID:** `swiper-9733-particle`  
**Block classes:** `size-100 fullwidth-swiper`  
**Selectors:** `.fullwidth-swiper`, `#swiper-9733-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  

**CSS rules matched:** 27  
...
### `contentarray` -- `.grid` `.grid-articles` `.grid-mobile-stacked` `.grid-no-text` `.grid-wide` `.grid-img-box-shadow-50` `.grid-mobile-horizontal-scroll` `.grid-columns-2` `.grid-hover-scale`

**Particle ID:** `contentarray-2999-particle`  
**Block classes:** `size-100 grid grid-articles grid-mobile-stacked grid-no-text grid-wide grid-img-box-shadow-50 grid-mobile-horizontal-scroll grid-columns-2 grid-hover-scale`  
**Selectors:** `.grid`, `.grid-articles`, `.grid-mobile-stacked`, `.grid-no-text`, `.grid-wide`, `.grid-img-box-shadow-50`, `.grid-mobile-horizontal-scroll`, `.grid-columns-2`, `.grid-hover-scale`, `#contentarray-2999-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/  
**Content hint:** _Upcoming Events_  

**CSS rules matched:** 19  
...
### `contentarray` -- `.grid` `.grid-articles` `.grid-mobile-stacked` `.grid-no-text` `.grid-wide` `.grid-img-box-shadow-50` `.grid-mobile-horizontal-scroll` `.grid-columns-2` `.grid-hover-scale` `.grid-title-white`

**Particle ID:** `contentarray-2999-particle`  
**Block classes:** `size-100 grid grid-articles grid-mobile-stacked grid-no-text grid-wide grid-img-box-shadow-50 grid-mobile-horizontal-scroll grid-columns-2 grid-hover-scale grid-title-white`  
**Selectors:** `.grid`, `.grid-articles`, `.grid-mobile-stacked`, `.grid-no-text`, `.grid-wide`, `.grid-img-box-shadow-50`, `.grid-mobile-horizontal-scroll`, `.grid-columns-2`, `.grid-hover-scale`, `.grid-title-white`, `#contentarray-2999-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _Upcoming Events_  
...
**Particle ID:** `custom-5289-particle`  
**Block classes:** `size-100 news-button`  
**Selectors:** `.news-button`, `#custom-5289-particle`  
**Pages:** https://sd-cemetery.backup.solutiosoftware.com/, https://sd-cemetery.backup.solutiosoftware.com/holy-cross, https://sd-cemetery.backup.solutiosoftware.com/home-gs  
**Content hint:** _View All Events_  
