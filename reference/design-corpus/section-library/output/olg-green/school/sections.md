# Section Layout Inventory — Olg-Green

**URL:** https://olg-green.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:28 UTC  
**Sections:** 9
...
**Section styles:** background: rgb(1, 109, 21)
...
**Grid 2** `100`
  - size-100 `.ql-icon-links` → `blockcontent`
**Grid 3** `100`
...
## Layout: `100/100/15|55|30/100`

### `g-navigation`

**Fingerprint:** `100/100/15|55|30/100`  
...
**Grid 3** `15|55|30`
  - size-15 `.hidden-phone` `.sh-circle-icon` → `logo`
...
**Grid 1** `33.3|33.3|33.3`
  ...
  - size-33.3 `.helplinks-widget-container` `.widget-container` → `contentarray`
