...
**Section styles:** background: rgb(37, 150, 210)
...
**Grid 1** `100`
  - size-100 `.grid` `.grid-articles` `.grid-mobile-stacked` `.grid-no-text` `.grid-wide` `.grid-img-box-shadow-50` `.grid-mobile-horizontal-scroll` `.grid-columns-2` `.grid-hover-scale` `.grid-title-white` → `contentarray`
**Grid 2** `100`
