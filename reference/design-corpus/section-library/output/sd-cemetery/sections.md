# Section Layout Inventory — SD-Cemetery

**URL:** https://sd-cemetery.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:15 UTC  
**Sections:** 11
...
**Grid 1** `100`
  - size-100 `.choose-container` → `contentarray`
...
**Section styles:** background: rgb(13, 66, 102)
...
**Grid 1** `100`
  - size-100 `.association-container` → `contentarray`
...
**Section styles:** background: rgb(255, 247, 227)
...
**Grid 1** `100`
  - size-100 `.grid` `.grid-articles` `.grid-mobile-stacked` `.grid-no-text` `.grid-wide` `.grid-img-box-shadow-50` `.grid-mobile-horizontal-scroll` `.grid-columns-2` `.grid-hover-scale` → `contentarray`
**Grid 2** `100`
...
**Grid 1** `100`
  - size-100 `.association-container` → `contentarray`
**Grid 2** `100`
  - size-100 `.linksources` → `blockcontent`
...
## Layout: `100/100/20|60|20/100`

### `g-navigation`

**Fingerprint:** `100/100/20|60|20/100`  
...
**Grid 2** `100`
  - size-100 `.translate-container` → `contentarray`
**Grid 3** `20|60|20`
  - size-20  → _(empty)_
...
## Layout: `100/100/30|40|30/100`

### `g-navigation`

**Fingerprint:** `100/100/30|40|30/100`  
**Section classes:** `.center-of-attention` `.stock`  
...
.g-content-array .g-array-item-text { margin-top: 15px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px }
.fas { -webkit-font-smoothing: antialiased; display: var(--fa-display,inline-block); font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-variant-numeric: normal; font-variant-east-asian: normal; font-variant-alternates: normal; font-variant-position: normal; font-variant-emoji: normal; line-height: 1; text-rendering: auto }
html body #g-navigation { --section-navigation-bg: var(--default-white); --main-menu-text-color: var(--default-white); --main-menu-text-color-hover: var(--default-white); --main-menu-bg: var(--secondary-color); --main-menu-bg-color: var(--secondary-color); --navigation-floating-social-padding: min(1vw, 1rem); --navigation-social-item-color: var(--default-white); --navigation-social-item-color-hover: var(--tertiary-color) }
.g-array-item-text { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
```
</details>
