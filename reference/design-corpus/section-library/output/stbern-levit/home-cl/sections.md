# Section Layout Inventory — StBern-Levit

**URL:** https://stbern-levit.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:21 UTC  
**Sections:** 10
...
**Fingerprint:** `100`  
**Section classes:** `.standard-ql`  
**Pages:**   
![section screenshot](screenshots/g-utility.png)

**Grid 1** `100`
  - size-100 `.ql-under-title` → `blockcontent`
...
#g-utility { color: rgb(0, 0, 0); background-image: initial; background-position-x: initial; background-position-y: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(255, 255, 255) }
...
**Pages:**   
![section screenshot](screenshots/g-bottom.png)

**Grid 1** `100`
  - size-100  → _(empty)_

**Section styles:** background: rgb(241, 242, 242)
...
**Pages:**   
![section screenshot](screenshots/g-container-footer.png)
...
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-container-top.png)
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-12 { flex-grow: 0; flex-shrink: 1; flex-basis: 12%; width: 12% }
.size-30 { flex-grow: 0; flex-shrink: 1; flex-basis: 30%; width: 30% }
.size-33 { flex-grow: 0; flex-shrink: 1; flex-basis: 33%; width: 33% }
.size-55 { flex-grow: 0; flex-shrink: 1; flex-basis: 55%; width: 55% }
...
html body #g-navigation { --section-navigation-bg: var(--default-white); --main-menu-text-color: var(--default-black); --main-menu-text-color-hover: var(--default-black); --main-menu-bg: var(--default-white); --main-menu-bg-color: var(--default-white); --navigation-floating-social-padding: min(1vw, 1rem); --navigation-toplevel-menu-item-font-family: var(--title-font-family) }
.g-array-item-text { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
...
**Section styles:** background: rgb(123, 0, 11)
...
## Layout: `100/55|12|33/100`

### `g-navigation`

**Fingerprint:** `100/55|12|33/100`  
**Section classes:** `.ole-faithful` `.stock`  
**Pages:**   
![section screenshot](screenshots/g-navigation.png)

**Grid 1** `100`
  - size-100 `.show-mobile` → `logo`
**Grid 2** `55|12|33`
  - size-55 `.hidden-phone` → `logo`
  - size-12  → _(empty)_
  - size-33 `.header-contact-container` → `contentarray`
**Grid 3** `100`
  - size-100  → `menu`
...
**Fingerprint:** `30|70`  
**Section classes:** `.floatator` `.slideshow-spacing`  
**Pages:**   
![section screenshot](screenshots/g-slideshow.png)

**Grid 1** `30|70`
  - size-30 `.mass-times-block` → `contentarray`
  - size-70 `.fullwidth-swiper` `.rotate-wide` → `swiper`
...
**Pages:**   
![section screenshot](screenshots/g-expanded.png)

**Grid 1** `33.3|33.3|33.3`
  - size-33.3 `.facebook-widget-container` `.widget-container` → `contentarray`
  - size-33.3 `.bulletin-widget-container` `.widget-container` → `contentarray`
  - size-33.3 `.links-widget-container` `.widget-container` → `contentarray`
...
.k-ui-namespace .koowa_media--gallery .koowa_media_contents * { box-sizing: border-box }
...
.k-ui-namespace .mod_docman .koowa_media--gallery .koowa_media_contents * { box-sizing: border-box }
...
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-container-main.png)

**Grid 1** `79|21`
  - size-79  → `contentarray`
  - size-21  → _(empty)_
...
.g-grid { display: flex; flex-direction: row; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; text-rendering: optimizespeed }
.g-block { flex-grow: 1; flex-shrink: 1; flex-basis: 0%; min-width: 0px; min-height: 0px }
.size-21 { flex-grow: 0; flex-shrink: 1; flex-basis: 21%; width: 21% }
.size-79 { flex-grow: 0; flex-shrink: 1; flex-basis: 79%; width: 79% }
.size-100 { width: 100%; max-width: 100%; flex-grow: 0; flex-basis: 100% }
...
#g-sidebar { background-image: initial; background-position-x: initial; background-position-y: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(255, 255, 255); color: rgb(0, 0, 0) }
.g-content-array { margin-left: -1.5rem; margin-right: -1.5rem }
.g-content-array .g-grid { margin-bottom: 2.5rem }
.g-content-array .g-grid:last-child { margin-bottom: 0px }
.g-content-array .g-content { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px }
