# Section Layout Inventory — StLaw-Alex

**URL:** https://stlaw-alex.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:27 UTC  
**Sections:** 11
...
**Grid 1** `100`
  - size-100 `.ql-boxtitle` → `blockcontent`

**Section styles:** background: rgb(247, 238, 231)
...
**Grid 1** `100`
  - size-100 `.welcome-container` → `contentarray`
...
**Section styles:** background: rgb(104, 31, 31)
...
**Fingerprint:** `100/100`  
**Section classes:** `.grand-entry` `.slideshow-spacing`  
**Pages:**   
...
**Grid 2** `100`
  - size-100 `.mass-times-overlay` → `contentarray`
...
html body #g-navigation { --section-navigation-bg: var(--background-color); --main-menu-text-color: var(--default-white); --main-menu-text-color-hover: var(--default-white); --main-menu-bg: var(--primary-color); --main-menu-bg-color: var(--primary-color); --navigation-floating-social-padding: min(1vw, 1rem) }
.g-array-item-text { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
.swiper-container { margin-left: auto; margin-right: auto; position: relative; overflow-x: hidden; overflow-y: hidden; list-style-position: initial; list-style-image: initial; list-style-type: none; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; z-index: 1 }
.swiper-wrapper { position: relative; width: 100%; height: 100%; z-index: 1; display: flex; transition-property: transform; box-sizing: content-box }
.swiper-slide { flex-shrink: 0; width: 100%; height: 100%; position: relative; transition-property: transform }
...
## Layout: `100/70|5|25/100`

### `g-navigation`

**Fingerprint:** `100/70|5|25/100`  
...
**Grid 2** `70|5|25`
  - size-70 `.hidden-phone` → `logo`
  - size-5  → _(empty)_
  - size-25 `.nav-contactinfo` → `contentarray`
**Grid 3** `100`
  - size-100  → `menu`
...
**Pages:**   
![section screenshot](screenshots/g-extension.png)
...
**Fingerprint:** `38|46|16`  
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-container-main.png)

**Grid 1** `38|46|16`
  - size-38  → `contentarray`
  - size-46  → `contentarray`
  - size-16  → _(empty)_

**Section styles:** background: rgb(244, 212, 195)
...
.size-38 { flex-grow: 0; flex-shrink: 1; flex-basis: 38%; width: 38% }
.size-46 { flex-grow: 0; flex-shrink: 1; flex-basis: 46%; width: 46% }
.size-100 { width: 100%; max-width: 100%; flex-grow: 0; flex-basis: 100% }
h2 { margin-top: 0.75rem; margin-right: 0px; margin-bottom: 1.5rem; margin-left: 0px; text-rendering: optimizelegibility }
.g-flushed { padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
.g-flushed .g-content { padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px }
...
**Fingerprint:** `50|50/100`  
**Section classes:** `.s-vertical-padding-2`  
**Pages:**   
![section screenshot](screenshots/g-bottom.png)

**Grid 1** `50|50`
  - size-50 `.sign-container` → `contentarray`
  - size-50 `.sl-container` → `blockcontent`
**Grid 2** `100`
  - size-100  → _(empty)_
...
.g-content.g-blockcontent-header { text-align: center; margin-bottom: 3rem }
.g-blockcontent-subcontent-title-text { font-weight: 700; font-size: 1.5rem; margin-top: 0px; margin-bottom: 1rem; line-height: 1.3 }
.g-blockcontent-subcontent-title { margin-bottom: 0px }
.g-blockcontent-subcontent-block .g-blockcontent-buttons { text-align: left }
.g-blockcontent-subcontent-desc { font-family: poppins, Helvetica, Tahoma, Geneva, Arial, sans-serif; font-weight: 300; font-size: 1.2rem; color: rgb(0, 0, 0); position: relative; margin-bottom: 0.625rem; line-height: 1.4 }
.g-blockcontent-buttons { margin-top: 0.5rem; margin-bottom: 1.5rem; text-align: center; text-decoration-line: underline; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; font-size: 1.4vw }
.g-content-array { margin-left: -1.5rem; margin-right: -1.5rem }
.g-content-array .g-grid { margin-bottom: 2.5rem }
.g-content-array .g-grid:last-child { margin-bottom: 0px }
