# Section Layout Inventory — StLiz-Melville

**URL:** https://stliz-melville.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:42 UTC  
**Sections:** 10
...
**Grid 1** `100`
  - size-100 `.ql-windowsill` → `blockcontent`

**Section styles:** background: rgba(16, 37, 64, 0.85)
...
**Section styles:** background: rgb(239, 231, 216)
...
**Section styles:** background: rgba(16, 37, 64, 0.9)
...
**Section styles:** background: rgb(16, 37, 64)
...
## Layout: `100/100/59|5|36/100`

### `g-navigation`

**Fingerprint:** `100/100/59|5|36/100`  
**Section classes:** `.free-menu` `.stock`  
**Pages:**   
...
**Grid 2** `100`
  - size-100 `.nav-social-icons` → `social`
**Grid 3** `59|5|36`
  - size-59 `.hidden-phone` → `logo`
  - size-5  → _(empty)_
  - size-36 `.ql-toplinks-studius` → `blockcontent`
**Grid 4** `100`
  - size-100  → `menu`
...
**Grid 1** `33.3|33.3|33.3`
  - size-33.3 `.column-container` → `contentarray`
  - size-33.3 `.column-container` → `contentarray`
  - size-33.3 `.column-container` → `contentarray`
