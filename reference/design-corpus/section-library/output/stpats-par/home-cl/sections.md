# Section Layout Inventory — StPats-Par

**URL:** https://stpats-par.backup.solutiosoftware.com  
**Scanned:** 2026-06-17 17:25 UTC  
**Sections:** 14
...
**Grid 1** `100`
  - size-100 `.fullwidth-swiper` → `swiper`

**Section styles:** background: rgb(239, 239, 239)
...
#swiper-9733 .slide { background-color: rgba(0, 0, 0, 0.1) }
```
</details>
...
**Pages:**   
![section screenshot](screenshots/g-above.png)

**Grid 1** `100`
  - size-100 `.ql-shamrocks` → `blockcontent`
...
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-feature.png)

**Grid 1** `100`
  - size-100 `.mission-container` → `contentarray`
...
**Grid 1** `100`
  - size-100 `.stewardship-container` → `blockcontent`
...
**Grid 1** `100`
  - size-100 `.flocknotes-container` → `contentarray`
...
**Section styles:** background: rgba(0, 27, 62, 0.9)
...
**Grid 2** `100`
  - size-100 `.nav-container` → `contentarray`
...
**Section styles:** background: rgb(0, 27, 62)
...
**Fingerprint:** `42|42|16`  
**Section classes:** _(none)_  
**Pages:**   
![section screenshot](screenshots/g-showcase.png)

**Grid 1** `42|42|16`
  - size-42 `.facebook-widget-container` `.widget-container` → `contentarray`
  - size-42 `.bulletin-widget-container` `.widget-container` → `contentarray`
  - size-16 `.ads-903` `.side-ads` `.ads-901` `.ads-902` → _(empty)_
...
```css
.k-icon-document-pdf { speak: none; text-rendering: optimizelegibility; -webkit-font-smoothing: antialiased; text-transform: none; line-height: 1; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-variant-numeric: normal; font-variant-east-asian: normal; font-variant-alternates: normal; font-variant-position: normal; font-variant-emoji: normal; font-weight: normal; font-family: k-icons }
.k-icon--size-default { font-size: 16px }
...
.k-ui-namespace .koowa_header__item--image_container { text-align: center; width: 1%; padding-right: 6px }
...
.k-ui-namespace .k-visually-hidden.k-visually-hidden.k-visually-hidden { position: absolute; overflow-x: hidden; overflow-y: hidden; clip: rect(0px, 0px, 0px, 0px); height: 1px; width: 1px; margin-top: -1px; margin-right: -1px; margin-bottom: -1px; margin-left: -1px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: none; border-left-style: none; border-top-color: currentcolor; border-right-color: currentcolor; border-bottom-color: currentcolor; border-left-color: currentcolor; border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial }
.k-ui-namespace .mod_docman ul { display: block; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; list-style-position: initial; list-style-image: initial; list-style-type: none }
.k-ui-namespace .mod_docman ul li { position: relative }
.k-ui-namespace .mod_docman ul li .koowa_header { margin-top: 0px; margin-right: 0px; margin-bottom: 2px; margin-left: 0px; line-height: 1.5em }
.k-ui-namespace .mod_docman ul li .koowa_header .label { vertical-align: text-bottom }
.k-ui-namespace .mod_docman ul .module_document__info { clear: both; display: block }
.k-ui-namespace .mod_docman ul.mod_docman_icons .module_document__info { padding-left: 30px }
.k-ui-namespace .mod_docman ul.mod_docman_icons .module_document__description { padding-left: 30px }
.k-ui-namespace .mod_docman ul .module_document__description { clear: both; display: block }
.k-ui-namespace .mod_docman.mod_docman--documents ul li { margin-bottom: 8px }
.k-ui-namespace .mod_docman.mod_docman--documents ul li:last-child { margin-bottom: 0px }
* { box-sizing: inherit }
section { display: block }
a { background-image: initial; background-position-x: initial; background-position-y: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: transparent; text-decoration-line: none; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial }
img { height: auto; max-width: 100%; display: inline-block; vertical-align: middle; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: none; border-left-style: none; border-top-color: currentcolor; border-right-color: currentcolor; border-bottom-color: currentcolor; border-left-color: currentcolor; border-image-source: initial; border-image-slice: initial; border-image-width: initial; border-image-outset: initial; border-image-repeat: initial }
...
.size-42 { flex-grow: 0; flex-shrink: 1; flex-basis: 42%; width: 42% }
h3 { margin-top: 0.75rem; margin-right: 0px; margin-bottom: 1.5rem; margin-left: 0px; text-rendering: optimizelegibility }
ul { margin-top: 1.5rem; margin-bottom: 1.5rem }
.g-flushed { padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
.g-flushed .g-content { padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px }
...
**Grid 1** `50|50`
  - size-50 `.news-container` `.stack-container` → `contentarray`
  - size-50 `.calendar-widget` `.stack-container` → `contentarray`

**Section styles:** background: rgb(0, 27, 62) | background-image: (set)
...
.g-content-array .g-array-item-text { margin-top: 15px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px }
.g-array-item-text { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px }
.rokminievents3 * { box-sizing: border-box }
.rme-items { overflow-x: hidden; overflow-y: hidden; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; position: relative; display: flex; flex-wrap: wrap; list-style-position: initial; list-style-image: initial; list-style-type: none }
.rme-timeline { position: relative; margin-top: 10px; margin-right: 1%; margin-bottom: 10px; margin-left: 1% }
.rme-timeline-bar { margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px }
.rme-timeline-points { list-style-position: initial; list-style-image: initial; list-style-type: none; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; height: 18px; display: flex }
.rme-timeline-point { margin-top: -1px; margin-right: 0px; margin-bottom: -1px; margin-left: 0px; text-align: center; cursor: pointer; position: relative; line-height: 19px; -webkit-box-flex: 1; flex-grow: 1; flex-shrink: 1; flex-basis: 0%; transition-behavior: normal; transition-duration: 0.2s; transition-timing-function: ease-out; transition-delay: 0s; transition-property: background }
.rme-timeline-point:first-child { border-top-left-radius: 4px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 4px; margin-left: -1px }
.rme-timeline-point:last-child { border-top-left-radius: 0px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 0px; margin-right: -1px }
.rme-timeline-point span { display: inline-block; width: 12px; height: 12px; border-top-left-radius: 100%; border-top-right-radius: 100%; border-bottom-right-radius: 100%; border-bottom-left-radius: 100%; cursor: pointer; vertical-align: middle }
.rme-timeline-date { opacity: 0; visibility: hidden; height: 0px; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; overflow-x: hidden; overflow-y: hidden; position: absolute; bottom: 32px; left: 50%; margin-left: -60px; width: 120px; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px; font-size: 90%; display: inline-block; background-image: initial; background-position-x: initial; background-position-y: initial; background-size: initial; background-repeat: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgba(0, 0, 0, 0.6); transition-behavior: normal; transition-duration: 0.2s; transition-timing-function: ease-out; transition-delay: 0s; transition-property: opacity }
```
</details>
